import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e as t}from"./app.09ab47b8.js";const p={},o=t(`<h1 id="druid连接器配置示例" tabindex="-1"><a class="header-anchor" href="#druid连接器配置示例" aria-hidden="true">#</a> Druid连接器配置示例</h1><h2 id="druid写连接器示例配置" tabindex="-1"><a class="header-anchor" href="#druid写连接器示例配置" aria-hidden="true">#</a> Druid写连接器示例配置</h2><p>假设当前有一个测试Druid集群，其master地址为&quot;127.0.0.1:64086&quot;，则可以通过如下配置写入test_druid_datasource资料源。</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
