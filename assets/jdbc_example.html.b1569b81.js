import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as i,c as a,a as n,b as s,d as u,w as o,e as l,r as d}from"./app.09ab47b8.js";const r={},c=n("h1",{id:"jdbc-example",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#jdbc-example","aria-hidden":"true"},"#"),s(" Jdbc Example")],-1),v=l(`<h2 id="mysql-example" tabindex="-1"><a class="header-anchor" href="#mysql-example" aria-hidden="true">#</a> MySQL Example</h2><h3 id="mysql-source" tabindex="-1"><a class="header-anchor" href="#mysql-source" aria-hidden="true">#</a> MySQL source</h3><h4 id="mysql-table-sync" tabindex="-1"><a class="header-anchor" href="#mysql-table-sync" aria-hidden="true">#</a> MySQL table sync</h4><div class="language-Json line-numbers-mode" data-ext="Json"><pre class="language-Json"><code>{
    &quot;job&quot;:{
        &quot;reader&quot;:{
