import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as e,e as t}from"./app.09ab47b8.js";const i={},a=t(`<h1 id="jdbc连接器示例" tabindex="-1"><a class="header-anchor" href="#jdbc连接器示例" aria-hidden="true">#</a> Jdbc连接器示例</h1><h2 id="mysql-example" tabindex="-1"><a class="header-anchor" href="#mysql-example" aria-hidden="true">#</a> MySQL Example</h2><h3 id="mysql-source" tabindex="-1"><a class="header-anchor" href="#mysql-source" aria-hidden="true">#</a> MySQL source</h3><h4 id="mysql-table-sync" tabindex="-1"><a class="header-anchor" href="#mysql-table-sync" aria-hidden="true">#</a> MySQL table sync</h4><div class="language-Json line-numbers-mode" data-ext="Json"><pre class="language-Json"><code>{
    &quot;job&quot;:{
        &quot;reader&quot;:{
