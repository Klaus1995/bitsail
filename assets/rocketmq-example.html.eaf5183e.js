import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e as t}from"./app.09ab47b8.js";const o={},p=t(`<h1 id="rocketmq连接器配置示例" tabindex="-1"><a class="header-anchor" href="#rocketmq连接器配置示例" aria-hidden="true">#</a> RocketMQ连接器配置示例</h1><h2 id="rocketmq-writer-example" tabindex="-1"><a class="header-anchor" href="#rocketmq-writer-example" aria-hidden="true">#</a> RocketMQ Writer example</h2><p>假设我们在本地启动了一个RocketMQ服务，其name server地址为 &quot;127.0.0.1:9876&quot;, 并且我们在其中创建了一个名为 &quot;test_topic&quot; 的topic。</p><p>那么我们可以使用如下的配置文档写入上述topic：</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
