import{_ as s}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as n,c as a,e as t}from"./app.09ab47b8.js";const e={},o=t(`<h1 id="elasticsearch连接器使用示例" tabindex="-1"><a class="header-anchor" href="#elasticsearch连接器使用示例" aria-hidden="true">#</a> Elasticsearch连接器使用示例</h1><p>如下展示了如何使用用户参数配置写入指定的elasticsearch索引。</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
