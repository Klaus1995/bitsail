import{_ as e}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as n,c as a,e as s}from"./app.09ab47b8.js";const i={},t=s(`<h1 id="bitsail-convertion-flink-hive" tabindex="-1"><a class="header-anchor" href="#bitsail-convertion-flink-hive" aria-hidden="true">#</a> bitsail-convertion-flink-hive</h1><p>本模块中的<code>HivewritableExtractor</code>支持将bitsail支持的<code>Row</code>转化为hive <code>Writable</code>数据。 转化完成后，用户可使用<code>org.apache.hadoop.hive.ql.exec.RecordWriter</code>将转化后的<code>Writable</code>数据方便地写入hive中。</p><p>下文将详细介绍<code>GeneralWritableExtractor</code>，一种<code>HivewritableExtractor</code>的通用实现，可用于多种存储格式的hive表，例如parquet、orc、text等。</p><h2 id="支持的数据类型" tabindex="-1"><a class="header-anchor" href="#支持的数据类型" aria-hidden="true">#</a> 支持的数据类型</h2><p><code>GeneralWritableExtractor</code>支持常见的hive基础数据类型，以及List、Map、Struct复杂数据类型。 常见的基础数据类型包括：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> TINYINT
 SMALLINT
 INT
 BIGINT
 BOOLEAN
