import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c as p,a as n,b as s,d as e,w as u,e as l,r as i}from"./app.09ab47b8.js";const c={},r=n("h1",{id:"kudu-connector-configration-examples",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#kudu-connector-configration-examples","aria-hidden":"true"},"#"),s(" Kudu connector configration examples")],-1),d=l(`<h2 id="kudu-reader-example" tabindex="-1"><a class="header-anchor" href="#kudu-reader-example" aria-hidden="true">#</a> Kudu reader example</h2><p>Assuming there is a test kudu cluster with master address &quot;127.0.0.1:64086&quot;, then we can use the following configuration to read <code>test_kudu_table</code> table.</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
