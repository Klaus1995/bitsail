import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e as t}from"./app.09ab47b8.js";const o={},p=t(`<h1 id="hudi连接器使用示例" tabindex="-1"><a class="header-anchor" href="#hudi连接器使用示例" aria-hidden="true">#</a> Hudi连接器使用示例</h1><h2 id="hudi读连接器示例" tabindex="-1"><a class="header-anchor" href="#hudi读连接器示例" aria-hidden="true">#</a> Hudi读连接器示例</h2><p>读取hudi表的用户配置:</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
