import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e as t}from"./app.09ab47b8.js";const p={},o=t(`<h1 id="redis连接器配置示例" tabindex="-1"><a class="header-anchor" href="#redis连接器配置示例" aria-hidden="true">#</a> Redis连接器配置示例</h1><h2 id="redis写连接器" tabindex="-1"><a class="header-anchor" href="#redis写连接器" aria-hidden="true">#</a> Redis写连接器</h2><p>假设在本地起了一个端口为6379的Redis。用于写入该Redis的配置如下:</p><p>String</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
